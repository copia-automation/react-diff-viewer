...
function AlignmentRow(_a) {
    var hideLineNumbers = _a.hideLineNumbers, largestPossibleLineNumber = _a.largestPossibleLineNumber, splitView = _a.splitView;
...
export function Title(_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(AlignmentRow, { hideLineNumbers: hideLineNumbers, largestPossibleLineNumber: largestPossibleLineNumber, splitView: splitView }),
        React.createElement(TitleText, { hideLineNumbers: hideLineNumbers, leftTitle: leftTitle, rightTitle: rightTitle, splitView: splitView, styles: styles })));
}
