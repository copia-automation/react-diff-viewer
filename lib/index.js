...
function DiffViewer(_a) {
    ...
    // const styles = computeStyles(props.styles, useDarkTheme);
        ...
        React.createElement("tbody", null,
            ...
            linesToRender.slice(0, 100).map(function (line, i) {
                ...
                if (typeof line === 'object' && 'num' in line) {
                    ...
                    node = splitView
                        ? (React.createElement(RenderSplitView, { lineInfo: lineProps, renderProps: renderProps, index: lineIndex })) : React.createElement(RenderInlineView, { lineInfo: lineProps, renderProps: renderProps, index: lineIndex });
                }
