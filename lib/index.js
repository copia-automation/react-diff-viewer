...
function RenderLineFromProps(_a) {
    ...
    if (typeof line === "object" && "num" in line) {
        return (React.createElement(Node, { key: i, index: i, renderNodeWrapper: renderProps.renderNodeWrapper },
            React.createElement(SkippedLineIndicator, __assign({}, line, { renderProps: renderProps, expandBlockIdsSet: expandedBlockIdsSet, setExpandedBlockIdsSet: setExpandedBlockIdsSet }))));
    }
...
function DiffViewer(_a) {
    ...
    return (React.createElement(TableVirtuoso, { style: {
            ...
            height: "100%",
            minHeight: 400,
        }, data: linesToRender, fixedHeaderContent: function () { return React.createElement(Title, __assign({}, renderProps)); }, itemContent: function (index, line) { return (React.createElement(RenderLineFromProps, { key: index, line: line, i: index, expandedBlockIdsSet: expandedBlockIdsSet, setExpandedBlockIdsSet: setExpandedBlockIdsSet, renderProps: renderProps })); }, components: {
