...
var RenderSplitView_1 = require("./Components/RenderSplitView");
var Node_1 = require("./Components/Node");
var InlineView_1 = require("./Components/InlineView");
var SkippedLineIndicator_1 = require("./Components/SkippedLineIndicator");
function RenderLineFromProps(_a) {
    var line = _a.line, i = _a.i, expandedBlockIdsSet = _a.expandedBlockIdsSet, setExpandedBlockIdsSet = _a.setExpandedBlockIdsSet, renderProps = _a.renderProps;
    if (typeof line === "object" && "num" in line) {
        return (React.createElement(Node_1.Node, { key: i, index: i, renderNodeWrapper: renderProps.renderNodeWrapper },
            React.createElement(SkippedLineIndicator_1.SkippedLineIndicator, __assign({}, line, { renderProps: renderProps, expandBlockIdsSet: expandedBlockIdsSet, setExpandedBlockIdsSet: setExpandedBlockIdsSet }))));
    }
    var lineIndex = line.index, lineProps = __rest(line, ["index"]);
    if (renderProps.splitView) {
        return (React.createElement(Node_1.Node, { key: i, index: i, renderNodeWrapper: renderProps.renderNodeWrapper },
            React.createElement(RenderSplitView_1.SplitView, { lineInfo: lineProps, renderProps: renderProps, index: lineIndex })));
    }
    return (React.createElement(Node_1.Node, { key: i, index: i, renderNodeWrapper: renderProps.renderNodeWrapper },
        React.createElement(InlineView_1.InlineView, { lineInfo: lineProps, renderProps: renderProps, index: lineIndex })));
}
function DiffViewer(_a) {
    ...
    return (React.createElement("table", { className: (0, classnames_1.default)(styles.diffContainer, (_b = {},
        ...
        React.createElement("tbody", null,
            React.createElement(Title_1.Title, __assign({}, renderProps)),
            linesToRender.slice(0, 100).map(function (line, i) { return (React.createElement(RenderLineFromProps, { key: i, line: line, i: i, expandedBlockIdsSet: expandedBlockIdsSet, setExpandedBlockIdsSet: setExpandedBlockIdsSet, renderProps: renderProps })); }))));
}
