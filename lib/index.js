...
function DiffViewer(_a) {
    ...
    React.useEffect(function () {
        ...
        worker.postMessage({
            oldValue: oldValue, //: oldValue.slice(0, 10000),
            newValue: newValue, //: newValue.slice(0, 10000),
    ...
    return (React.createElement(TableVirtuoso, { style: {
            ...
            height: "100%",
            minHeight: 400,
        }, data: linesToRender, fixedHeaderContent: function () { return (React.createElement(Title, __assign({}, renderProps, { 
            // This isn't exactly accurate, but should be good enough
            largestPossibleLineNumber: largestLineNumber }))); }, itemContent: function (index, line) { return (React.createElement(RenderLineFromProps, { key: index, line: line, i: index, expandBlockById: expandBlockById, renderProps: renderProps })); }, components: {
