...
function DiffViewer(_a) {
    ...
    return (React.createElement(TableVirtuoso, { style: {
            ...
            largestPossibleLineNumber: linesToRender.length }))); }, itemContent: function (index, line) { return (React.createElement(RenderLineFromProps, { key: index, line: line, i: index, expandBlockById: expandBlockById, renderProps: renderProps })); }, components: {
