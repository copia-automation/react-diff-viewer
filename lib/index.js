...
function RenderLineFromProps(_a) {
    var line = _a.line, i = _a.i, expandBlockById = _a.expandBlockById;
    var splitView = useReactDiffViewerContext().splitView;
    if ("num" in line) {
        return (React.createElement(Node, { key: i, index: i },
            React.createElement(SkippedLineIndicator, __assign({}, line, { expandBlockById: expandBlockById }))));
    }
    if (splitView) {
        return (React.createElement(Node, { key: i, index: i },
            React.createElement(SplitView, __assign({}, line))));
    }
    return (React.createElement(Node, { key: i, index: i },
        React.createElement(InlineView, __assign({}, line))));
}
function DiffViewer(_a) {
    ...
    var props = __assign({ oldValue: oldValue, newValue: newValue, splitView: false, highlightLines: highlightLines, disableWordDiff: disableWordDiff, compareMethod: compareMethod, styles: styleOverrides, hideLineNumbers: hideLineNumbers, extraLinesSurroundingDiff: extraLinesSurroundingDiff, showDiffOnly: showDiffOnly, useDarkTheme: useDarkTheme, linesOffset: linesOffset }, rest);
    ...
    return (React.createElement(ReactDiffViewerContextProvider, { value: renderProps },
        React.createElement(TableVirtuoso, { style: {
                ...
                maxHeight: "100%",
                height: 1000,
            }, data: linesToRender, fixedHeaderContent: function () { return (React.createElement(Title, __assign({}, renderProps, { largestPossibleLineNumber: largestLineNumber }))); }, itemContent: function (index, line) { return (React.createElement(RenderLineFromProps, { key: index, line: line, i: index, expandBlockById: expandBlockById })); }, components: {
