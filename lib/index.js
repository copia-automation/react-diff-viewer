...
var DiffViewer = /** @class */ (function (_super) {
    ...
    function DiffViewer(props) {
        ...
        _this.resetCodeBlocks = function () {
            if (_this.state.expandedBlocks.size > 0) {
                _this.setState({
        ...
        _this.onBlockExpand = function (id) {
            var newState = _this.state.expandedBlocks.add(id);
            _this.setState({
         ...
         */
        _this.renderSkippedLineIndicator = function (_a) {
            var _b;
            var num = _a.num, blockNumber = _a.blockNumber, leftBlockLineNumber = _a.leftBlockLineNumber, rightBlockLineNumber = _a.rightBlockLineNumber;
            var _c = _this.props, hideLineNumbers = _c.hideLineNumbers, splitView = _c.splitView;
            ...
            return (React.createElement("tr", { key: "".concat(leftBlockLineNumber, "-").concat(rightBlockLineNumber), className: _this.styles.codeFold },
                ...
                React.createElement("td", { className: (0, classnames_1.default)((_b = {},
                        _b[_this.styles.codeFoldGutter] = isUnifiedViewWithoutLineNumbers,
                        _b)) }),
         ...
         */
        _this.getLinesToRender = function () {
            ...
            lineInformation.forEach(function (line, i) {
                ...
                if (_this.props.showDiffOnly) {
                    ...
                    if (line.left.type === compute_lines_1.DiffType.DEFAULT &&
                        ...
                        !_this.state.expandedBlocks.has(diffBlockStart)) {
        ...
        _this.render = function () {
            ...
            var _b = _this.props, oldValue = _b.oldValue, newValue = _b.newValue, useDarkTheme = _b.useDarkTheme, leftTitle = _b.leftTitle, rightTitle = _b.rightTitle, splitView = _b.splitView, hideLineNumbers = _b.hideLineNumbers, renderNodeWrapper = _b.renderNodeWrapper;
            if (typeof oldValue !== 'string' || typeof newValue !== 'string') {
                throw Error('"oldValue" and "newValue" should be strings');
            }
            _this.styles = _this.computeStyles(_this.props.styles, useDarkTheme);
            var linesToRender = _this.getLinesToRender().slice(0, 100);
                ...
                React.createElement("tbody", null,
                    ...
                    linesToRender.slice(0, 100).map(function (line, i) {
                        ...
                        if (typeof line === 'object' && 'num' in line) {
                            node = _this.renderSkippedLineIndicator(line);
                        }
                        else {
                            var _a = line, lineIndex = _a.index, lineProps = __rest(_a, ["index"]);
                            // const lineInfo = line as LineInformationProps;
                            node = splitView
                                ? _this.renderSplitView(lineProps, lineIndex)
                                : _this.renderInlineView(lineProps, lineIndex);
                        }
                        return (React.createElement(RenderNode, { key: i, index: i, renderNodeWrapper: renderNodeWrapper }, node));
                    }))));
        };
        _this.state = {
            expandedBlocks: new Set(),
