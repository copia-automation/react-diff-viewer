...
function DiffViewer(_a) {
    ...
    return (React.createElement(TableVirtuoso, { style: {
            ...
            maxHeight: "100%",
            height: 1000,
        }, data: linesToRender, fixedHeaderContent: function () { return (React.createElement(Title, __assign({}, renderProps, { largestPossibleLineNumber: largestLineNumber }))); }, itemContent: function (index, line) { return (React.createElement(RenderLineFromProps, { key: index, line: line, i: index, expandBlockById: expandBlockById, renderProps: renderProps })); }, components: {
