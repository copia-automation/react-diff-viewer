(() => {
  ...
  var computeDiff = (oldValue, newValue, compareMethod = "diffChars" /* CHARS */) => {
    ...
    if (allowedMethods.includes(compareMethod) && Object.prototype.hasOwnProperty.call(jsDiff, compareMethod) && typeof jsDiff[compareMethod] === "function") {
      methodToUse = compareMethod;
    }
    const diffArray = jsDiff[methodToUse](
      oldValue,
      newValue
    );
    const computedDiff = {
