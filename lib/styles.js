...
exports.default = (function (styleOverride, useDarkTheme) {
    ...
    var content = (0, css_1.css)({
        width: '100%',
        label: 'content',
    });
    var splitView = (0, css_1.css)((_a = {},
        _a[".".concat(content)] = {
            width: '50%',
        },
        _a.label = 'split-view',
        _a));
    var diffContainer = (0, css_1.css)({
        width: '100%',
    ...
    var codeFoldContent = (0, css_1.css)({
        color: variables.codeFoldContentColor,
        label: 'code-fold-content',
    });
    var contentText = (0, css_1.css)({
        color: variables.diffViewerColor,
        label: 'content-text',
    });
    var titleBlock = (0, css_1.css)((_b = {
        ...
        _b));
    var lineNumber = (0, css_1.css)({
        color: variables.gutterColor,
        label: 'line-number',
    });
    var diffRemoved = (0, css_1.css)((_c = {
    ...
    var diffAdded = (0, css_1.css)((_d = {
        ...
        _d.label = 'diff-added',
        _d));
    var wordDiff = (0, css_1.css)({
        padding: 2,
        display: 'inline-flex',
        borderRadius: 1,
        label: 'word-diff',
    });
    var wordAdded = (0, css_1.css)({
        background: variables.wordAddedBackground,
        label: 'word-added',
    });
    var wordRemoved = (0, css_1.css)({
        background: variables.wordRemovedBackground,
        label: 'word-removed',
    });
    var codeFoldGutter = (0, css_1.css)({
        backgroundColor: variables.codeFoldGutterBackground,
        label: 'code-fold-gutter',
    });
    var codeFold = (0, css_1.css)({
    ...
    var emptyLine = (0, css_1.css)({
        backgroundColor: variables.emptyLineBackground,
        label: 'empty-line',
    });
    var marker = (0, css_1.css)((_e = {
            width: 25,
            paddingLeft: 10,
            paddingRight: 10,
            userSelect: 'none',
        ...
        _e));
    var highlightedLine = (0, css_1.css)((_f = {
        ...
        _f));
    var highlightedGutter = (0, css_1.css)({
        label: 'highlighted-gutter',
    });
    var gutter = (0, css_1.css)((_g = {
            userSelect: 'none',
            minWidth: 50,
            padding: '0 10px',
            label: 'gutter',
