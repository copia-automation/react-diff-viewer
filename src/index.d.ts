...
declare class DiffViewer extends React.Component<
...
> {
  ...
  static propTypes: {
    ...
    leftTitle: PropTypes.Requireable<
      NonNullable<string | PropTypes.ReactElementLike>
    >;
    rightTitle: PropTypes.Requireable<
      NonNullable<string | PropTypes.ReactElementLike>
    >;
